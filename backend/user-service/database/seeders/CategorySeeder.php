    ...
    public function run(): void
    {
        $categories = [
            [
                ...
                'image_url' => 'https://ndbmthuppkyozfawrenb.supabase.co/storage/v1/object/public/categories/cat-facial.jpg',
            ],
            [
                'name' => 'Masajes',
            ...
            [
                ...
                'image_url' => 'https://ndbmthuppkyozfawrenb.supabase.co/storage/v1/object/public/categories/cat-limpieza-facial.jpg',
            ],
            [
                'name' => 'Corporal',
                'description' => 'Productos completos para el cuidado del cuerpo',
                'image_url' => 'https://ndbmthuppkyozfawrenb.supabase.co/storage/v1/object/public/categories/cat-corporal.jpg',
            ],
            [
                'name' => 'Cabello',
