      ...
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 z-10 mb-8 md:mb-0">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-youorganic-green leading-tight">
            Skincare Orgánico <br />
            <span className="text-youorganic-dark">Puro y Natural</span>
          </h1>
          <p className="text-lg md:text-xl mb-8 text-youorganic-dark/80 max-w-md">
            Descubre nuestros productos naturales, libres de crueldad animal, elaborados
            con ingredientes orgánicos para nutrir tu piel y respetar el planeta.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button
              ...
              size="lg"
            >
              <Link to="/assistant">Asistente de Belleza</Link>
            </Button>
          </div>
        </div>
